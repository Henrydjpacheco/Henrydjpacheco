import { CLEAR, FILTER_BY_DATA_UBICATION, FILTER_BY_TYPE, GET_ALL_POKEMON, GET_BY_NAME, GET_DETAIL, GET_TYPES, POST_POKEMON, SORT_BY_ATTACK, SORT_BY_NAME } from '../actions';
const initialState = {
    pokemon: [],
    allPokemon: [],
    types: [],
